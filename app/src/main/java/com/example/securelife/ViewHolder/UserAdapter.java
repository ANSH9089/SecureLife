...
import com.example.securelife.ResidentChatActivity;
import com.example.securelife.chatwindo;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.viewholder> {
    ...
    public UserAdapter(ResidentChatActivity mainActivity, ArrayList<Resident> usersArrayList) {
    ...
    public void onBindViewHolder(@NonNull UserAdapter.viewholder holder, int position) {
        ...
        Resident users = usersArrayList.get(position);
        holder.username.setText(users.getName());
        holder.userstatus.setText(users.getPhone());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("uid",users.getBlockNo());
